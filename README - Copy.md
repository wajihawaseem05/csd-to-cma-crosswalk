...
**These two routes were cross-checked against each other.** Running
point-in-polygon on all 5,600 2001 CSDs and comparing with the inherited answers
where both exist gives **97.94% agreement (n = 5,201)**. That is the only
validation available for 2001, since no independent 2001 source exists.
...
| 2001 dual-method agreement | 97.94% (n = 5,201) |
